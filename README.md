...
- Live election currently configured for polling: `2026-rlp`
- Public site targets: `https://wahl-monitor.de/2026-bw/`, `https://wahl-monitor.de/2026-rlp/`
- GitHub Actions polling workflow: `.github/workflows/poll.yml`
