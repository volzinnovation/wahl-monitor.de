# Validation: full Git history and external comparison
...
- Full reachable and first-parent data-commit sets are equal: 124 commits, 122 dated captures.
- 582 original source objects match their archived SHA-256. One early zero template lacks its original CSV; this is disclosed.
- 69,482 geographic and 1,011,997 U+B field comparisons over all captures. No within-row arithmetic or normalized/source differences.
